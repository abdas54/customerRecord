		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comeroscustomerrecord-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comeroscustomerrecord-display": {
								"semanticObject": "comeroscustomerrecord",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eros.customerrecord",
									"url": sap.ui.require.toUrl("com/eros/customerrecord")
								}
							}
						}
					}
